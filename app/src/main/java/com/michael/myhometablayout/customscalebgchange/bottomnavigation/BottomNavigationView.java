...
public class BottomNavigationView extends RelativeLayout {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isTablet) {
            ...
            shadow.setBackgroundResource(R.drawable.shape_shadow);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                LayoutParams backgroundLayoutParams = new LayoutParams(
        ...
        for (int i = 0; i < bottomNavigationItems.size(); i++) {
            ...
            final View view = inflater.inflate(R.layout.layout_bottom_navigation, this, false);
    ...
    /**
     * Disable shape_shadow of BottomNavigationView
     */
